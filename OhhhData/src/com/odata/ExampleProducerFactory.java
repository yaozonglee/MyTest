...
public class ExampleProducerFactory implements ODataProducerFactory {
    ...
    public ODataProducer create(Properties arg0) {
         ...
         // expose a list of employees
         producer.register(Employee.class, Integer.class, "Employees", new Func<Iterable<Employee>>() {
           public Iterable<Employee> apply() {
        	   List<Employee> empMgr = new ArrayList<Employee>();
        	   empMgr.add(new Employee("John", "Sales", 123));
        	   empMgr.add(new Employee("Peter", "Support", 456));
        	   empMgr.add(new Employee("John", "Finance", 789));
        	   return empMgr;
           }
         }, Funcs.method(Employee.class, Integer.class, "empValue"));
         return producer;
